...
public class Scheduled {
	...
	public static void main(String[] args) throws IOException {
		...
		travelTime = getTravelDistance("33.230593,-97.146718",your_flight.getOrigin()[2]+","+your_flight.getOrigin()[3],false,false,false); //gets the travel time in seconds
		...
		if(your_flight != null) {
			...
			System.out.println("Departure time: "+your_flight.getDepart()+"\n"
			+	"Arrival time: "+your_flight.getArrive());
			System.out.println("\nReccomended time to leave:");
			//-------------------------------------
			
			time_to_leave -= nTime;
			leave_time = (time_to_leave/3600)+":"+((time_to_leave%3600)/60)+":"+(time_to_leave%60);
			System.out.println("Carry-On Only (Already Checked-In): " + leave_time);
			time_to_leave += nTime;
			
			time_to_leave -= cTime;
			leave_time = (time_to_leave/3600)+":"+((time_to_leave%3600)/60)+":"+(time_to_leave%60);
			System.out.println("Check-In Only: " + leave_time);
			time_to_leave += cTime;
			
			time_to_leave -= bTime;
			leave_time = (time_to_leave/3600)+":"+((time_to_leave%3600)/60)+":"+(time_to_leave%60);
			System.out.println("Luggage Check-In: " + leave_time);
			time_to_leave += bTime;
			
			System.out.println("\nTime for customs:");
			System.out.println("Carry-On Only (Already Checked-In): " + n + " min");
			System.out.println("Check-In Only: " + c + " min");
			System.out.println("Luggage Check-In: " + b + " min");
			
			System.out.println("\nTime for traffic: " + Integer.parseInt(travelTime)/60 + " min");
